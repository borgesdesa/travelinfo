...
{
    var http = new XMLHttpRequest();
    const url = 'https://api.opencagedata.com/geocode/v1/json?q='+lat+'+'+lng+'&key=dbace63870e841c8a502768580593b43';
    http.open("GET", url);
    http.send();
    http.onreadystatechange = (e) => {
        var response = http.responseText;
...
{
    var http = new XMLHttpRequest();
    const url = 'http://api.openweathermap.org/data/2.5/find?lat='+latitude+'&lon='+longitude+'&appid=dbace63870e841c8a502768580593b43&units=metric';
    http.open("GET", url);
    http.send();
    http.onreadystatechange = (e) => {
        var response = http.responseText;
...
{
    var http = new XMLHttpRequest();
    const url = 'http://www.apilayer.net/api/live?access_key=54ad3f7760eecbef4f70092089a9d9f1&format=1';
    http.open("GET", url);
    http.send();
